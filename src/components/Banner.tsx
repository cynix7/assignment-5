    ...
    return (
        <div className="flex flex-col sm:flex-row justify-between items-center container mx-auto">
            <div className="flex flex-col gap-4">
                ...
                <p className="text-[#475569] text-center sm:text-left">
                ...
                <div className="text-center sm:text-left">
                    <button className="bg-linear-to-r from-[#FF5722] to-[#D81B7E] text-white px-4 py-2 rounded-md mt-10 mr-3 cursor-pointer">Explore Technologies</button>
                    <button className="border border-[#E5E7EB] text-[#475569] px-12 py-2 rounded-md cursor-pointer">Learn More</button>
                </div>
            </div>
